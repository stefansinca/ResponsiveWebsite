...
// MISSION modify
const missionModifAuthenticityPage = () => {
    ...
    getParagraph.innerHTML = 'Authenticity';
    let paragraphStyle = `
    font-size: 3em;
    text-align: left;
...
const createParagraph = () => {
    ...
    let createText = document.createTextNode('AUTHENTICITY');
...
const createParagraph2 = () => {
    ...
    let createTextForFrontP = document.createTextNode('power of data');
...
const addTable = () => {
    ...
    let secondColumn = ["Papua", "Blockchain", "Florin Roman", "Data", "$514.000"];
