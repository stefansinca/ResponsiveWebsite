...
const getParagraph = document.querySelector('.presentation-text');
const getMissionDiv = document.querySelector('.mission-div');
...
const missionModif = () => {
    ...
    getParagraph.innerHTML = 'Automation';
    let paragraphStyle = `
    font-size: 3em;
    text-align: left;
...
const insertAfter = (referenceElem, newElem) => {
    referenceElem.parentNode.insertBefore(newElem, referenceElem.nextSibbling);
}
...
const createParagraph = () => {
    ...
    let createText = document.createTextNode('AUTOMATION');
...
const createParagraph2 = () => {
    ...
    let createTextForFrontP = document.createTextNode('excellent and efficient');
...
const createImg = () => {
    ...
    backImg.src = './img/automation.jpeg';
...
const addTable = () => {
    ...
    let secondColumn = ["Lugoj", "Blockchain", "Alexandru Panait", "Automation", "$125.000"];
...
const navigateProjects = () => {
    let getProjects = document.querySelector('.projects-btn');
    getProjects.href = 'file:///Users/aipss/Documents/Projects/Business%20Presentation%20Website/index.html#main-img-id';

    setTimeout(navigateProjects, 10)
}
